...
dissimilarity transforms, the Euclidean diagnostics and the positive
semi-definite repair all work; the inference, stability and scalability
layers are declared, documented and not yet implemented — calling them
raises an error that says which phase they belong to.
